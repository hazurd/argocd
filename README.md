# Self Managed Argo CD - Appception
...
# Clone Repository
Clone hazurd/argocd repository to your local device.
```
git clone https://github.com/hazurd/argocd.git
```
...
server:
  ...
  config:
    repositories: |
      - type: git
        url: https://github.com/hazurd/argocd.git
      - name: argo-helm
        type: helm
